...
def build_file_change_history(known_commits, file_change_history):
    ...
    `commit_history` : networkx DiGraph, required, output of this function, empty container for the file change history 
    ...
    partitionned_filechanges = collections.defaultdict(list)
